...
-keep public class com.eloelo.analytics.AnalyticsSdk {
    public <init>(...);
    public *;
}
-keep public class com.eloelo.analytics.AnalyticsSdk$Builder {
    public <init>(...);
    public *;
}
...
-keep class com.eloelo.analytics.AnalyticsEvent { *; }

# Keep the TypeConverter used by Room to store the 'params' map.
-keep class com.eloelo.analytics.EventParamsConverter { <init>(...); }
...
-keep interface com.eloelo.analytics.db.AnalyticsEventDao { *; }
-keep class com.eloelo.analytics.db.AnalyticsDatabase { *; }


# --- WorkManager Rules ---
# WorkManager instantiates Worker classes using reflection, so we must keep the
# class and its default constructor.
-keep class com.eloelo.analytics.worker.EventSyncWorker {
